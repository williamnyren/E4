...
const double tau = 48.5*1e-3; /* ms = milli sec */ /* LOW: 147.5 \mu sec, HIGH: 48.5 \mu sec */ 
const double friction_coefficient = 1/tau;
const double omega_0 = 2.0*M_PI * 3.1; /* 1/ms */
const double T = 297.0; /* K */
const long int sim_steps = (long int)(2000)/((long int)(dt*1e3));
const long int n_timesteps = 30000*sim_steps ; /* X * [production group steps] */
...
int main(){
    ...
    unsigned long int seed1 = 1635484;
